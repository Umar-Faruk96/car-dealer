...
<x-app-layout pageTitle="My Cars" bodyClass="page-my-cars">
    <main>
        <div>
            <div class="container">
                        ...
                        <table class="table">
                            ...
                            @forelse($carsOfUser as $car)
                                <tr>
                                    ...
                                    <td>{{ Carbon::parse($car->created_at)->diffForHumans() }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center p-large">You don't have any cars yet. Add one <a
                                                href="{{ route('car.create') }}"
                                                class="btn btn-edit inline-flex items-center">here</a>.
                                    </td>
                                </tr>
                            @endforelse
                            </tbody>
